...
- Improved some tooltips in the UI

## v1.0.1-hotfix
- Added a refresh button for the car dropdown in the RL Cars tab
    - Should fix the issue of no cars showing up (maybe)

## v1.0.1
- Added header & footer in settings GUI (plugin version and discord link)
